...
//OLD v4  superlayer=1;  //HARDCODED!!!
  ...
  L1Phase2MuDTPhDigi trigprim(bx,   // ubx (m_bx)
                              ...
                              (int)round(phiAngle*65536./0.8),   // uphi (_phiAngle)
