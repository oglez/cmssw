...
process = cms.Process("DTNT",eras.Run3)  ## ESTO ES LA HOSTIA DE LIOSO CON LO QUE CAMBIA... !OJITO!
...
process.GlobalTag.globaltag = '122X_dataRun3_Prompt_v3' ## Run3 setup data
